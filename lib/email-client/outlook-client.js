...
class OutlookClient extends BaseClient {
    ...
    async ensureSubscription() {
        if (process.env.LMA_SETTINGS_IGNORE_WATCH) {
            this.logger.info({ msg: 'Ignoring Outlook subscription watch due to LMA_SETTINGS_IGNORE_WATCH', account: this.account });
            return;
        }
